...
class DeepLabResNetModel(Network):
    def setup(self, is_training, num_classes, is_inference, add_extra_head):
        ...
        (self.feed('res5b_relu',
             ...
             .atrous_conv(3, 3, 7, 6, padding='SAME', relu=False, name='fc1_voc12_c0'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, 7, 12, padding='SAME', relu=False, name='fc1_voc12_c1'))

        (self.feed('res5c_relu')
             .atrous_conv(3, 3, 7, 18, padding='SAME', relu=False, name='fc1_voc12_c2'))
