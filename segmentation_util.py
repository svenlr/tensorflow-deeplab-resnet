...
MERGE_LISTS_VERY_EXTREME = [
    "background",
    ["left-leg", "right-leg"],
    ["left-arm", "right-arm", "watch", "wristband", "left-hand", "right-hand", "glove"],
    ["jacket/windbreaker/hoodie", "coat", "sweater", "t-shirt", "polo-shirt", "singlet", "other-upper-body-clothes",
     "tie", "scarf", "bikini/bra"],
    ["pants", "shorts/swim-shorts", "skirt", "other-lower-body-clothes", "belt", "stockings"],
    ["dress", "jumpsuit", "other-full-body-clothes", "robe"],
    "torso-skin"]
...
DROP_IMAGES_WITH_CATEGORIES_VERY_EXTREME = []
