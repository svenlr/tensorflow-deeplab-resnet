...
def combine_segmentations(segmentations_path, seg_combined_path, max_num_images=None):
    ...
    merger = SegmentationMerge(MERGE_LISTS_VERY_EXTREME, DROP_IMAGES_WITH_CATEGORIES_VERY_EXTREME)
...
def create_segmentation_list_string(base_path, max_num_images=None):
    ...
    segmentations_combined_path = os.path.join(base_path, "parsing_annos_very_extreme")
...
if __name__ == '__main__':
    ...
    output_file = sys.argv[2] if len(sys.argv) > 2 else "train_merge_very_extreme.list"
